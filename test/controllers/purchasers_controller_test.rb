...
class PurchasersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchaser" do
    assert_difference('Purchaser.count') do
      post purchasers_url, params: { purchaser: { description: @purchaser.description, email: @purchaser.email, name: @purchaser.name, phone: @purchaser.phone } }
    end
  ...
  test "should update purchaser" do
    patch purchaser_url(@purchaser), params: { purchaser: { description: @purchaser.description, email: @purchaser.email, name: @purchaser.name, phone: @purchaser.phone } }
