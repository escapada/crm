...
class PurchasesTest < ApplicationSystemTestCase
  ...
  test "creating a Purchase" do
    ...
    fill_in "Comment", with: @purchase.comment
    fill_in "Count", with: @purchase.count
    fill_in "Description", with: @purchase.description
    fill_in "Done", with: @purchase.done
    fill_in "Finish", with: @purchase.finish
    fill_in "Purchaser", with: @purchase.purchaser_id
    fill_in "Soon", with: @purchase.soon
